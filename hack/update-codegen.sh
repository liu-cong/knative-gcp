...
${CODEGEN_PKG}/generate-groups.sh "deepcopy,client,informer,lister" \
  github.com/google/knative-gcp/pkg/client github.com/google/knative-gcp/pkg/apis \
  "pubsub:v1alpha1 pubsub:v1beta1 messaging:v1alpha1 events:v1alpha1 policy:v1alpha1 broker:v1beta1" \
  --go-header-file ${REPO_ROOT_DIR}/hack/boilerplate/boilerplate.go.txt
...
${KNATIVE_CODEGEN_PKG}/hack/generate-knative.sh "injection" \
  github.com/google/knative-gcp/pkg/client github.com/google/knative-gcp/pkg/apis \
  "pubsub:v1alpha1 pubsub:v1beta1 messaging:v1alpha1 events:v1alpha1 duck:v1alpha1 duck:v1beta1 policy:v1alpha1 broker:v1beta1" \
  --go-header-file ${REPO_ROOT_DIR}/hack/boilerplate/boilerplate.go.txt
