...
func (r *reconcilerImpl) Reconcile(ctx context.Context, key string) error {
	...
	original, err := r.Lister.Triggers(namespace).Get(name)
...
func (r *reconcilerImpl) updateStatus(existing *v1beta1.Trigger, desired *v1beta1.Trigger) error {
	...
	return reconciler.RetryUpdateConflicts(func(attempts int) (err error) {
		...
		if attempts > 0 {
			existing, err = r.Client.EventingV1beta1().Triggers(desired.Namespace).Get(desired.Name, metav1.GetOptions{})
			if err != nil {
				return err
			}
		}
		...
		_, err = r.Client.EventingV1beta1().Triggers(existing.Namespace).UpdateStatus(existing)
		return err
	})
}
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1beta1.Trigger) (*v1beta1.Trigger, error) {
	...
	actual, err := r.Lister.Triggers(resource.Namespace).Get(resource.Name)
	if err != nil {
		return resource, err
	}
	...
	resource, err = r.Client.EventingV1beta1().Triggers(resource.Namespace).Patch(resource.Name, types.MergePatchType, patch)
	if err != nil {
