...
func (r *reconcilerImpl) updateStatus(existing *v1alpha1.EventPolicyBinding, desired *v1alpha1.EventPolicyBinding) error {
	...
	return reconciler.RetryUpdateConflicts(func(attempts int) (err error) {
		...
		if attempts > 0 {
			existing, err = r.Client.PolicyV1alpha1().EventPolicyBindings(desired.Namespace).Get(desired.Name, metav1.GetOptions{})
			if err != nil {
				return err
			}
		}
		...
		_, err = r.Client.PolicyV1alpha1().EventPolicyBindings(existing.Namespace).UpdateStatus(existing)
		return err
	})
}
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.EventPolicyBinding) (*v1alpha1.EventPolicyBinding, error) {
	...
	resource, err = r.Client.PolicyV1alpha1().EventPolicyBindings(resource.Namespace).Patch(resource.Name, types.MergePatchType, patch)
	if err != nil {
